...
* ITEM_COMBINATION_RESULT_ALREADY_OWNS_COLLECTIBLE
...
* REWARD_ENTRY_TYPE_SKILL_AND_ATTRIBUTE_POINTS
...
### SkillRespecPaymentType
* SKILL_RESPEC_PAYMENT_TYPE_GOLD
* SKILL_RESPEC_PAYMENT_TYPE_RESPEC_SCROLL
...
* CAMPAIGN_ALLIANCE_LOCK_REASON_NOT_LOCKED
...
* TICKET_CATEGORY_REPORT_GUILD_DECLINE_MESSAGE
* TICKET_CATEGORY_REPORT_GUILD_LISTING
* TICKET_CATEGORY_REPORT_GUILD_NAME
...
* GetDateElementsFromTimestamp(*id64* _timestamp_)
...
* GetDayOfTheWeekIndex(*id64* _timestamp_)
...
* DoesGuildHistoryCategoryHaveOutstandingRequest(*integer* _guildId_, *[GuildHistoryCategory|#GuildHistoryCategory]* _category_)
** _Returns:_ *bool* _hasOutstandingRequest_

* IsGuildHistoryCategoryRequestQueued(*integer* _guildId_, *[GuildHistoryCategory|#GuildHistoryCategory]* _category_)
** _Returns:_ *bool* _isQueued_

* RequestMoreGuildHistoryCategoryEvents(*integer* _guildId_, *[GuildHistoryCategory|#GuildHistoryCategory]* _category_, *bool* _queueRequestIfOnCooldown_)
...
** _Returns:_ *integer* _eventType_, *integer* _secsSinceEvent_, *variant* _param1_, *variant* _param2_, *variant* _param3_, *variant* _param4_, *variant* _param5_, *variant* _param6_, *integer* _eventId_
...
* GetCollectibleCategoryName(*integer* _collectibleId_)
...
* GetSlotAbilityCost(*luaindex* _actionSlotIndex_)
** _Returns:_ *integer* _abilityCost_, *integer* _mechanicType_

* GetSlotTexture(*luaindex* _actionSlotIndex_)
** _Returns:_ *string* _texture_, *string* _weapontexture_, *string* _activationAnimation_

* GetSlotName(*luaindex* _actionSlotIndex_)
** _Returns:_ *string* _name_

* GetSlotItemQuality(*luaindex* _actionSlotIndex_)
...
* OnSlotDownAndUp *private* (*luaindex* _actionSlotIndex_)

* OnSlotDown *private* (*luaindex* _actionSlotIndex_)

* OnSlotUp *private* (*luaindex* _actionSlotIndex_)
...
* GetSlotItemCount(*luaindex* _actionSlotIndex_)
** _Returns:_ *integer:nilable* _count_

* GetSlotItemSound(*luaindex* _actionSlotIndex_)
** _Returns:_ *integer* _itemSoundCategory_

* IsSlotItemConsumable(*luaindex* _actionSlotIndex_)
...
* IsValidItemForSlot(*[Bag|#Bag]* _bagId_, *integer* _bagSlotId_, *luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _valid_
...
* IsValidQuestItemForSlot(*integer* _questItemId_, *luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _valid_
...
* GetComparisonEquipSlotsFromBagItem(*[Bag|#Bag]* _bagId_, *integer* _slotIndex_)
** _Returns:_ *integer:nilable* _comparisonSlot1_, *integer:nilable* _comparisonSlot2_
...
* GetFirstFreeValidSlotForItem(*[Bag|#Bag]* _bagId_, *integer* _slotIndex_)
** _Returns:_ *luaindex:nilable* _freeSlot_

* GetFirstFreeValidSlotForSimpleAction(*[ActionBarSlotType|#ActionBarSlotType]* _actionType_, *integer* _actionId_)
** _Returns:_ *luaindex:nilable* _emptyActionSlotIndex_

* FindActionSlotMatchingItem(*[Bag|#Bag]* _bagId_, *integer* _slotIndex_)
** _Returns:_ *luaindex:nilable* _currentSlot_

* FindActionSlotMatchingSimpleAction(*[ActionBarSlotType|#ActionBarSlotType]* _actionType_, *integer* _actionId_)
...
* IsSlotLocked(*luaindex* _actionSlotIndex_)
...
* ClearSlot *protected* (*luaindex* _actionSlotIndex_)

* SelectSlotAbility *protected* (*luaindex* _abilityIndex_, *luaindex* _actionSlotIndex_)

* SelectSlotItem *protected* (*[Bag|#Bag]* _bagId_, *integer* _bagSlotId_, *luaindex* _actionSlotIndex_)

* SelectSlotSimpleAction *protected* (*[ActionBarSlotType|#ActionBarSlotType]* _actionType_, *integer* _actionId_, *luaindex* _actionSlotIndex_)

* SelectLastSlottedItem *protected* (*luaindex* _actionSlotIndex_)
...
* GetSlotItemLink(*luaindex* _actionSlotIndex_)
** _Returns:_ *string* _itemLink_
...
* GetEffectiveAbilityIdForAbilityOnHotbar(*integer* _abilityId_, *[HotBarCategory|#HotBarCategory]* _hotbarCategory_)
...
* IsSlotToggled(*luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _toggledOn_

* HasCostFailure(*luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _status_

* HasRequirementFailure(*luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _status_

* HasWeaponSlotFailure(*luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _status_

* HasTargetFailure(*luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _status_

* HasRangeFailure(*luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _status_

* HasLeapKeepTargetFailure(*luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _status_

* HasSubzoneFailure(*luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _status_

* HasStatusEffectFailure(*luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _status_

* HasFallingFailure(*luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _status_

* HasSwimmingFailure(*luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _status_

* HasMountedFailure(*luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _status_

* HasReincarnatingFailure(*luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _status_

* HasActivationHighlight(*luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _status_

* HasNonCostStateFailure(*luaindex* _actionSlotIndex_)
** _Returns:_ *bool* _status_
...
* GetAbilityCastInfo(*integer* _abilityId_, *integer:nilable* _overrideRank_)
** _Returns:_ *bool* _channeled_, *integer* _castTime_, *integer* _channelTime_

* GetAbilityTargetDescription(*integer* _abilityId_, *integer:nilable* _overrideRank_)
** _Returns:_ *string:nilable* _targetDescription_

* GetAbilityRange(*integer* _abilityId_, *integer:nilable* _overrideRank_)
** _Returns:_ *integer* _minRangeCM_, *integer* _maxRangeCM_

* GetAbilityRadius(*integer* _abilityId_, *integer:nilable* _overrideRank_)
** _Returns:_ *integer* _radius_

* GetAbilityAngleDistance(*integer* _abilityId_)
** _Returns:_ *integer* _angleDistance_

* GetAbilityDuration(*integer* _abilityId_, *integer:nilable* _overrideRank_)
** _Returns:_ *integer* _duration_

* GetAbilityIcon(*integer* _abilityId_)
** _Returns:_ *textureName* _icon_

* GetAbilityCost(*integer* _abilityId_, *integer:nilable* _overrideRank_)
...
* GetAbilityDescription(*integer* _abilityId_, *integer:nilable* _overrideRank_)
** _Returns:_ *string* _description_
...
* GetAbilityBuffType(*integer* _abilityId_)
...
* WouldOutfitBeHidden(*luaindex* _outfitIndex_)
** _Returns:_ *bool* _isHidden_, *[VisualLayer|#VisualLayer]* _highestPriorityVisualLayerThatIsShowing_
...
** _Returns:_ *textureName* _icon_, *string* _itemName_, *integer* _quality_, *integer* _stackCount_, *string* _sellerName_, *integer* _timeRemaining_, *integer* _purchasePrice_, *[CurrencyType|#CurrencyType]* _currencyType_, *id64* _itemUniqueId_, *number* _purchasePricePerUnit_
...
** _Returns:_ *textureName* _icon_, *string* _itemName_, *integer* _quality_, *integer* _stackCount_, *string* _sellerName_, *integer* _timeRemaining_, *integer* _salePrice_, *[CurrencyType|#CurrencyType]* _currencyType_, *id64* _itemUniqueId_, *number* _salePricePerUnit_
...
* GetBattlegroundMaxActiveSequencedObjectives(*integer* _battlegroundId_)
...
* GetEmperorAllianceBonusAbilityId(*integer* _campaignId_, *[Alliance|#Alliance]* _alliance_)
** _Returns:_ *integer* _abilityId_
...
** _Returns:_ *textureName* _icon_, *string* _name_, *integer* _stack_, *integer* _price_, *[ItemQuality|#ItemQuality]* _quality_, *bool* _meetsRequirementsToEquip_
...
** _Returns:_ *integer* _lootId_, *string* _name_, *textureName* _icon_, *integer* _count_, *integer* _quality_, *integer* _value_, *bool* _isQuest_, *bool* _stolen_, *[LootItemType|#LootItemType]* _lootType_
...
* GetSkillLineName(*[SkillType|#SkillType]* _skillType_, *luaindex* _skillLineIndex_)
** _Returns:_ *string* _name_

* GetSkillLineId(*[SkillType|#SkillType]* _skillType_, *luaindex* _skillLineIndex_)
** _Returns:_ *integer* _skillLineId_

* GetSkillLineUnlockText(*[SkillType|#SkillType]* _skillType_, *luaindex* _skillLineIndex_)
...
** _Returns:_ *integer* _abilityId_, *luaindex* _skillLineRankNeeded_
...
* GetSkillLineAnnouncementIcon(*[SkillType|#SkillType]* _skillType_, *luaindex* _skillLineIndex_)
** _Returns:_ *textureName* _announcementIcon_

* GetSkillLineCraftingGrowthType(*[SkillType|#SkillType]* _skillType_, *luaindex* _skillLineIndex_)
...
* PrepareSkillPointAllocationRequest(*[SkillPointAllocationMode|#SkillPointAllocationMode]* _allocationMode_, *[SkillRespecPaymentType|#SkillRespecPaymentType]* _respecPaymentType_)
...
* StartAchievementSearch(*string* _searchString_)
...
** _Returns:_ *string* _translationName_, *string* _itemName_, *textureName* _icon_, *integer* _sellPrice_, *bool* _meetsUsageRequirement_, *[EquipType|#EquipType]* _equipType_, *integer* _itemStyleId_, *[ItemQuality|#ItemQuality]* _quality_
...
** _Returns:_ *string* _traitName_, *string* _itemName_, *textureName* _icon_, *integer* _sellPrice_, *bool* _meetsUsageRequirement_, *[EquipType|#EquipType]* _equipType_, *integer* _itemStyleId_, *[ItemQuality|#ItemQuality]* _quality_
...
** _Returns:_ *string* _name_, *textureName* _icon_, *integer* _stack_, *integer* _sellPrice_, *bool* _meetsUsageRequirement_, *[EquipType|#EquipType]* _equipType_, *[ItemType|#ItemType]* _itemType_, *integer* _itemStyleId_, *[ItemQuality|#ItemQuality]* _quality_, *[ItemUISoundCategory|#ItemUISoundCategory]* _soundCategory_, *integer* _itemInstanceId_
...
** _Returns:_ *string* _name_, *textureName* _icon_, *integer* _stack_, *integer* _sellPrice_, *bool* _meetsUsageRequirement_, *[EquipType|#EquipType]* _equipType_, *integer* _itemStyleId_, *[ItemQuality|#ItemQuality]* _quality_, *[ProspectiveAlchemyResult|#ProspectiveAlchemyResult]* _prospectiveAlchemyResult_
...
** _Returns:_ *string* _name_, *textureName* _icon_, *integer* _requiredQuantity_, *integer* _sellPrice_, *[ItemQuality|#ItemQuality]* _quality_
...
** _Returns:_ *string* _name_, *textureName* _icon_, *integer* _stack_, *integer* _sellPrice_, *bool* _meetsUsageRequirement_, *[ItemQuality|#ItemQuality]* _quality_
...
** _Returns:_ *string* _itemName_, *textureName* _icon_, *integer* _stack_, *integer* _sellPrice_, *bool* _meetsUsageRequirement_, *[EquipType|#EquipType]* _equipType_, *integer* _itemStyleId_, *[ItemQuality|#ItemQuality]* _quality_, *integer* _itemInstanceId_, *integer* _skillRequirement_, *integer* _createsItemOfLevel_, *bool* _isChampionPoint_
...
** _Returns:_ *[ItemTraitType|#ItemTraitType]:nilable* _traitType_, *string* _itemName_, *textureName* _icon_, *integer* _sellPrice_, *bool* _meetsUsageRequirement_, *integer* _itemStyleId_, *[ItemQuality|#ItemQuality]* _quality_
...
* CanItemBeDeconstructed(*[Bag|#Bag]* _bagId_, *integer* _slotIndex_, *[TradeskillType|#TradeskillType]* _craftingSkillType_)
...
** _Returns:_ *string* _itemName_, *textureName* _icon_, *integer* _currentStack_, *integer* _sellPrice_, *bool* _meetsUsageRequirement_, *[EquipType|#EquipType]* _equipType_, *integer* _itemStyleId_, *[ItemQuality|#ItemQuality]* _quality_
...
** _Returns:_ *string* _itemName_, *textureName* _icon_, *integer* _sellPrice_, *bool* _meetsUsageRequirement_, *[EquipType|#EquipType]* _equipType_, *integer* _itemStyleId_, *[ItemQuality|#ItemQuality]* _quality_
...
* GetOutfitName(*luaindex* _outfitIndex_)
** _Returns:_ *string* _name_

* GetOutfitSlotInfo(*luaindex* _outfitIndex_, *[OutfitSlot|#OutfitSlot]* _outfitSlot_)
...
* SendOutfitChangeRequest(*bool* _useFlatCurrency_, *luaindex* _outfitIndex_, *[OutfitSlot|#OutfitSlot]* _outfitSlot_, *integer* _collectibleId_, *luaindex* _itemMaterialIndex_, *integer* _primaryDyeId_, *integer* _secondaryDyeId_, *integer* _accentDyeId_)
...
* RenameOutfit(*luaindex* _outfitIndex_, *string* _name_)
...
* CanEquippedItemBeShownInOutfitSlot(*[EquipSlot|#EquipSlot]* _equipSlot_, *[OutfitSlot|#OutfitSlot]* _outfitSlot_)
** _Returns:_ *bool* _canShowItem_

* GetApplyCostForIndividualOutfitSlot(*luaindex* _outfitIndex_, *[OutfitSlot|#OutfitSlot]* _outfitSlot_, *integer* _collectibleId_, *integer* _changedDyeCount_)
** _Returns:_ *integer* _applyCostGold_

* GetTotalApplyCostForOutfitSlots(*luaindex* _outfitIndex_, *[OutfitSlot|#OutfitSlot]* _outfitSlot_, *integer* _collectibleId_, *integer* _changedDyeCount_)
** _Returns:_ *integer* _totalCostGold_

* GetOutfitSlotsForCurrentlyHeldWeapons()
...
* AreDyeChannelsDyeableForOutfitSlotData(*[OutfitSlot|#OutfitSlot]* _outfitSlot_, *integer* _collectibleId_)
...
** _Returns:_ *[ClientGiftState|#ClientGiftState]* _state_, *bool* _seen_, *integer* _marketProductId_, *string* _senderDisplayName_, *string* _recipientDisplayName_, *integer* _expirationTimestampS_, *string* _note_
...
* HasGiftingGracePeriodStartedNotification()
** _Returns:_ *bool* _hasNotification_

* ClearGiftingGracePeriodStartedNotification()

* HasGiftingUnlockedNotification()
** _Returns:_ *bool* _hasGiftingUnlockedNotification_
...
* DoesBankHoldCurrency(*[Bag|#Bag]* _bankingBag_)
...
** _Returns:_ *textureName* _icon_, *integer* _stack_, *integer* _sellPrice_, *bool* _meetsUsageRequirement_, *bool* _locked_, *[EquipType|#EquipType]* _equipType_, *integer* _itemStyleId_, *[ItemQuality|#ItemQuality]* _quality_
...
* GetItemQuality(*[Bag|#Bag]* _bagId_, *integer* _slotIndex_)
** _Returns:_ *[ItemQuality|#ItemQuality]* _quality_
...
* TransferToGuildBank(*[Bag|#Bag]* _sourceBag_, *integer* _sourceSlot_)
...
* GetCombinationUnlockedCollectible(*integer* _combinationId_)
...
* GetCombinationFirstNonFragmentCollectibleComponentId(*integer* _combinationId_)
** _Returns:_ *integer* _firstNonFragmentCollectibleId_
...
* IsCollectibleActive(*integer* _collectibleId_)
** _Returns:_ *bool* _isActive_
...
* GetCollectibleForHouseBankBag(*[Bag|#Bag]* _houseBankBag_)
** _Returns:_ *integer* _collectibleId_

* GetCollectibleBankAccessBag(*integer* _collectibleId_)
** _Returns:_ *[Bag|#Bag]:nilable* _houseBankBag_
...
* DoesMarketProductCategoryContainNewMarketProducts(*[MarketDisplayGroup|#MarketDisplayGroup]* _displayGroup_, *luaindex* _topLevelIndex_, *luaindex:nilable* _categoryIndex_)
** _Returns:_ *bool* _containsNewProducts_

* DoesMarketProductCategoryOrSubcategoriesContainNewMarketProducts(*[MarketDisplayGroup|#MarketDisplayGroup]* _displayGroup_, *luaindex* _topLevelIndex_, *luaindex:nilable* _categoryIndex_)
** _Returns:_ *bool* _containsNewProducts_

* DoesMarketProductCategoryOrSubcategoriesContainEsoPlusMarketProducts(*[MarketDisplayGroup|#MarketDisplayGroup]* _displayGroup_, *luaindex* _topLevelIndex_, *luaindex:nilable* _categoryIndex_)
** _Returns:_ *bool* _containsEsoPlusProducts_

* DoesMarketProductCategoryOrSubcategoriesContainNewEsoPlusMarketProducts(*[MarketDisplayGroup|#MarketDisplayGroup]* _displayGroup_, *luaindex* _topLevelIndex_, *luaindex:nilable* _categoryIndex_)
** _Returns:_ *bool* _containsNewEsoPlusProducts_
...
* CouldPurchaseMarketProduct *private* (*integer* _marketProductId_, *luaindex:nilable* _presentationIndex_)
** _Returns:_ *[MarketPurchasableResult|#MarketPurchasableResult]* _expectedPurchaseResult_

* CouldGiftMarketProduct *private* (*integer* _marketProductId_, *luaindex:nilable* _presentationIndex_)
...
* GetMarketProductUnlockedByAchievementInfo(*integer* _marketProductId_)
** _Returns:_ *integer* _achievementId_, *bool* _hasCompletedAchievement_, *luaindex:nilable* _helpCategoryIndex_, *luaindex:nilable* _helpIndex_
...
* IsCollectiblePresentInEffectivelyEquippedOutfit(*integer* _collectibleId_)
...
** _Returns:_ *integer* _previewCollectionId_

* RemovePreviewCollection(*integer* _previewCollectionId_)

* SetPreviewCollectionShown(*integer* _previewCollectionId_, *bool* _show_)
** _Returns:_ *bool* _success_
...
* SetPreviewingOutfitIndexInPreviewCollection(*integer* _previewCollectionId_, *luaindex* _outfitIndex_)

* SetPreviewingUnequippedOutfitInPreviewCollection(*integer* _previewCollectionId_)

* ClearPreviewingOutfitIndexInPreviewCollection(*integer* _previewCollectionId_)

* AddOutfitSlotPreviewElementToPreviewCollection *private* (*integer* _previewCollectionId_, *[OutfitSlot|#OutfitSlot]* _outfitSlot_, *integer* _collectibleDefId_, *luaindex:nilable* _itemMaterialIndex_, *integer* _primaryDyeDefId_, *integer* _secondaryDyeDefId_, *integer* _accentDyeDefId_, *bool* _refreshIfShowing_)

* ClearOutfitSlotPreviewElementFromPreviewCollection(*integer* _previewCollectionId_, *[OutfitSlot|#OutfitSlot]* _outfitSlot_, *bool* _refreshIfShowing_)

* ClearAllOutfitSlotPreviewElementsFromPreviewCollection(*integer* _previewCollectionId_, *bool* _refreshIfShowing_)

* GetPreviewCollectionCurrentlyShown()
** _Returns:_ *integer* _previewCollectionId_

* GetOutfitSlotInfoForOutfitSlotInPreviewCollection(*integer* _previewCollectionId_, *[OutfitSlot|#OutfitSlot]* _outfitSlot_)
...
* PreviewInventoryItemAsFurniture(*[Bag|#Bag]* _bagId_, *integer* _slotIndex_, *luaindex* _variation_)

* PreviewStoreEntry(*luaindex* _entryIndex_, *luaindex* _variation_, *integer* _dyeBrushId_)

* PreviewStoreEntryAsFurniture(*luaindex* _entryIndex_, *luaindex* _variation_)

* PreviewTradingHouseSearchResultItem(*luaindex* _index_, *integer* _dyeBrushId_)

* PreviewTradingHouseSearchResultItemAsFurniture(*luaindex* _index_, *luaindex* _variation_)

* PreviewTradingHouseSearchResultItemLinkAsFurniture(*string* _itemLink_, *luaindex* _variation_)
...
* GetNumInventoryItemAsFurniturePreviewVariations(*[Bag|#Bag]* _bagId_, *integer* _slotIndex_)
** _Returns:_ *integer* _numVariations_

* GetInventoryItemAsFurniturePreviewVariationDisplayName(*[Bag|#Bag]* _bagId_, *integer* _slotIndex_, *luaindex* _variation_)
** _Returns:_ *string* _variationDisplayName_
...
* GetNumStoreEntryAsFurniturePreviewVariations(*luaindex* _entryIndex_)
** _Returns:_ *integer* _numVariations_

* GetStoreEntryAsFurniturePreviewVariationDisplayName(*luaindex* _entryIndex_, *luaindex* _variation_)
** _Returns:_ *string* _variationDisplayName_

* GetNumTradingHouseSearchResultItemAsFurniturePreviewVariations(*luaindex* _index_)
** _Returns:_ *integer* _numVariations_

* GetTradingHouseSearchResultItemAsFurniturePreviewVariationDisplayName(*luaindex* _index_, *luaindex* _variation_)
** _Returns:_ *string* _variationDisplayName_

* GetNumTradingHouseSearchResultItemLinkAsFurniturePreviewVariations(*string* _itemLink_)
** _Returns:_ *integer* _numVariations_

* GetTradingHouseSearchResultItemLinkAsFurniturePreviewVariationDisplayName(*string* _itemLink_, *luaindex* _variation_)
** _Returns:_ *string* _variationDisplayName_
...
* GetItemRewardItemLink(*integer* _rewardId_, *integer* _quantity_, *[LinkStyle|#LinkStyle]* _linkStyle_)
** _Returns:_ *string* _link_
...
* IsZoneStoryActivelyTracking()
** _Returns:_ *bool* _isActivelyTracking_
...
** _Returns:_ *string* _name_, *bool* _exists_, *bool* _active_, *integer* _minVersion_, *integer* _version_
...
* SetDefaultTextForVirtualKeyboard(*string* _aText_)
...
** _Returns:_ *number* _scaledPixelWidth_
...
* SetLineSpacing(*integer* _lineSpacingPixels_)
...
* SetNewLineX(*number* _newLineXPixels_)
...
* SetBagItem(*[Bag|#Bag]* _bagIndex_, *integer* _slotIndex_)
...
* SetCollectible(*integer* _collectibleId_, *bool* _addNickname_, *bool* _showPurchasableHint_, *bool* _showBlockReason_)
...
* SetProgressionAbility(*luaindex* _aProgressionIndex_, *integer* _aMorph_, *integer* _aRank_, *bool* _aShowAdvice_, *bool* _aAdvised_)
...
* SetReward(*integer* _rewardId_, *integer* _quantity_)
...
* SetSkillLine(*integer* _skillType_, *luaindex* _skillLineIndex_)
...
* GetWindowManager()
** _Returns:_ *object* _apRetWindowManager_
...
* GetAnimationManager()
** _Returns:_ *object* _apRetAnimationManager_
...
* EVENT_BATTLEGROUND_KILL (*string* _killedPlayerCharacterName_, *string* _killedPlayerDisplayName_, *[BattlegroundAlliance|#BattlegroundAlliance]* _killedPlayerBattlegroundAlliance_, *string* _killingPlayerCharacterName_, *string* _killingPlayerDisplayName_, *[BattlegroundAlliance|#BattlegroundAlliance]* _killingPlayerBattlegroundAlliance_, *[BattlegroundKillType|#BattlegroundKillType]* _battlegroundKillType_, *integer* _killingAbilityId_)
...
* EVENT_CRAFTING_STATION_INTERACT (*[TradeskillType|#TradeskillType]* _craftSkill_, *bool* _sameStation_)
...
* EVENT_CRAFT_STARTED (*[TradeskillType|#TradeskillType]* _craftSkill_)
...
* EVENT_END_CRAFTING_STATION_INTERACT (*[TradeskillType|#TradeskillType]* _craftSkill_)
* EVENT_END_CUTSCENE
...
* EVENT_GIFTING_GRACE_PERIOD_STARTED_NOTIFICATION_CLEARED
...
* EVENT_GUILD_BANK_ITEM_ADDED (*integer* _slotId_, *bool* _addedByLocalPlayer_, *[ItemUISoundCategory|#ItemUISoundCategory]* _itemSoundCategory_)
* EVENT_GUILD_BANK_ITEM_REMOVED (*integer* _slotId_, *bool* _addedByLocalPlayer_, *[ItemUISoundCategory|#ItemUISoundCategory]* _itemSoundCategory_)
...
* EVENT_HELP_SHOW_SPECIFIC_PAGE (*luaindex* _helpCategoryIndex_, *luaindex* _helpIndex_)
...
* EVENT_HOME_SHOW_LEADERBOARD_DATA_CHANGED (*integer* _voteCategory_, *[HouseCategoryType|#HouseCategoryType]* _houseCategory_)
...
* EVENT_INVENTORY_SINGLE_SLOT_UPDATE (*[Bag|#Bag]* _bagId_, *integer* _slotId_, *bool* _isNewItem_, *[ItemUISoundCategory|#ItemUISoundCategory]* _itemSoundCategory_, *integer* _inventoryUpdateReason_, *integer* _stackCountChange_, *string:nilable* _triggeredByCharacterName_, *string:nilable* _triggeredByDisplayName_)
...
* EVENT_OUTFIT_CHANGE_RESPONSE (*[ApplyOutfitChangesResult|#ApplyOutfitChangesResult]* _response_, *luaindex* _outfitIndex_)
* EVENT_OUTFIT_EQUIP_RESPONSE (*[EquipOutfitResult|#EquipOutfitResult]* _response_)
* EVENT_OUTFIT_RENAME_RESPONSE (*[SetOutfitNameResult|#SetOutfitNameResult]* _response_, *luaindex* _outfitIndex_)
...
* EVENT_QUEST_POSITION_REQUEST_COMPLETE (*integer* _taskId_, *[MapDisplayPinType|#MapDisplayPinType]* _pinType_, *number* _xLoc_, *number* _yLoc_, *number* _areaRadius_, *bool* _insideCurrentMapWorld_, *bool* _isBreadcrumb_)
...
* EVENT_SHOW_SUBTITLE (*[MsgChannelType|#MsgChannelType]* _channelType_, *string* _speakerName_, *string* _text_)
...
* EVENT_SLOT_IS_LOCKED_FAILURE (*[Bag|#Bag]* _bagId_, *integer* _slotId_)
...
* EVENT_START_SKILL_RESPEC (*[SkillPointAllocationMode|#SkillPointAllocationMode]* _allocationMode_, *[SkillRespecPaymentType|#SkillRespecPaymentType]* _paymentType_)
...
* EVENT_STORE_FAILURE (*[StoreFailure|#StoreFailure]* _reason_, *integer* _errorStringId_)
* EVENT_STUCK_BEGIN
...
* EVENT_UNIT_ATTRIBUTE_VISUAL_ADDED (*string* _unitTag_, *[UnitAttributeVisual|#UnitAttributeVisual]* _unitAttributeVisual_, *[DerivedStats|#DerivedStats]* _statType_, *[Attributes|#Attributes]* _attributeType_, *[CombatMechanicType|#CombatMechanicType]* _powerType_, *number* _value_, *number* _maxValue_, *integer* _sequenceId_)
* EVENT_UNIT_ATTRIBUTE_VISUAL_REMOVED (*string* _unitTag_, *[UnitAttributeVisual|#UnitAttributeVisual]* _unitAttributeVisual_, *[DerivedStats|#DerivedStats]* _statType_, *[Attributes|#Attributes]* _attributeType_, *[CombatMechanicType|#CombatMechanicType]* _powerType_, *number* _value_, *number* _maxValue_, *integer* _sequenceId_)
* EVENT_UNIT_ATTRIBUTE_VISUAL_UPDATED (*string* _unitTag_, *[UnitAttributeVisual|#UnitAttributeVisual]* _unitAttributeVisual_, *[DerivedStats|#DerivedStats]* _statType_, *[Attributes|#Attributes]* _attributeType_, *[CombatMechanicType|#CombatMechanicType]* _powerType_, *number* _oldValue_, *number* _newValue_, *number* _oldMaxValue_, *number* _newMaxValue_, *integer* _sequenceId_)
...
* EVENT_FRIEND_HERON_USER_INFO_UPDATED (*string* _displayName_, *string:nilable* _heronName_)
...
* EVENT_GUILD_HISTORY_CATEGORY_UPDATED (*integer* _guildId_, *[GuildHistoryCategory|#GuildHistoryCategory]* _category_)
* EVENT_GUILD_HISTORY_REFRESHED
* EVENT_GUILD_HISTORY_RESPONSE_RECEIVED (*integer* _guildId_, *[GuildHistoryCategory|#GuildHistoryCategory]* _category_)
...
* EVENT_PREPARE_FOR_JUMP (*string* _zoneName_, *string* _zoneDescription_, *string* _loadingTexture_, *[InstanceDisplayType|#InstanceDisplayType]* _instanceDisplayType_)
